...
|---------|-----------|---------|
| **Threat** | Potential danger to assets | APT groups, ransomware, misconfigurations |
...
|----------|------------|
| **Mitigate** | Reduce the risk by patching vulnerabilities, adding firewalls |
| **Accept** | Acknowledge it and proceed when mitigation costs exceed potential loss |
| **Transfer** | Shift risk to a third party through cyber insurance or SLAs |
